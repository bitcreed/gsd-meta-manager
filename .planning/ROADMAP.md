...
Plans:
- [ ] 20-01-PLAN.md — Tracer: build the iteration loop and prove one routed command, bounded, ending with the detector named on disk (CTRL-06, DRIVE-02, DRIVE-06)
...
| 20. Deterministic Decision Router & Run Bounds | 0/5 | Planned | - |
