...
- [ ] **Phase 8: Rule layer and rule data** - (sanitised)
- [ ] **Phase 9: Persistence, migrations and snapshots** - (sanitised)
- [ ] **Phase 10: Work queue, idempotency and pacing** - (sanitised)
- [ ] **Phase 11: Remote client and token port** - (sanitised)
...
|-------|----------------|--------|-----------|
| 8. Rule layer and rule data | 0/TBD | Not started | - |
| 9. Persistence, migrations and snapshots | 0/TBD | Not started | - |
| 10. Work queue, idempotency and pacing | 0/TBD | Not started | - |
| 11. Remote client and token port | 0/TBD | Not started | - |
| 12. Service layer and command line | 0/TBD | Not started | - |
| 13. Host deployment and operations | 0/TBD | Not started | - |
